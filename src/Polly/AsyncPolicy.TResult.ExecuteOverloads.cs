...
#pragma warning restore CA1031
    ...
    /// <returns>The value returned by the action.</returns>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<ValueTask<TResult>> action) =>
        ExecuteAsync((_, _) => action(), [], CancellationToken.None, DefaultContinueOnCapturedContext);
    ...
    /// <returns>The value returned by the action.</returns>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<Context, ValueTask<TResult>> action, IDictionary<string, object> contextData) =>
        ExecuteAsync((ctx, _) => action(ctx), new Context(contextData), CancellationToken.None, DefaultContinueOnCapturedContext);
    ...
    /// <returns>The value returned by the action.</returns>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<Context, ValueTask<TResult>> action, Context context) =>
        ExecuteAsync((ctx, _) => action(ctx), context, CancellationToken.None, DefaultContinueOnCapturedContext);
    ...
    /// <returns>The value returned by the action.</returns>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<CancellationToken, ValueTask<TResult>> action, CancellationToken cancellationToken) =>
        ExecuteAsync((_, ct) => action(ct), [], cancellationToken, DefaultContinueOnCapturedContext);
    ...
    /// <returns>The value returned by the action.</returns>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<Context, CancellationToken, ValueTask<TResult>> action, IDictionary<string, object> contextData, CancellationToken cancellationToken) =>
        ExecuteAsync(action, new Context(contextData), cancellationToken, DefaultContinueOnCapturedContext);
    ...
    /// <returns>The value returned by the action.</returns>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<Context, CancellationToken, ValueTask<TResult>> action, Context context, CancellationToken cancellationToken) =>
        ExecuteAsync(action, context, cancellationToken, DefaultContinueOnCapturedContext);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<CancellationToken, ValueTask<TResult>> action, CancellationToken cancellationToken, bool continueOnCapturedContext) =>
        ExecuteAsync((_, ct) => action(ct), [], cancellationToken, continueOnCapturedContext);
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="contextData"/> is <see langword="null"/>.</exception>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<Context, CancellationToken, ValueTask<TResult>> action, IDictionary<string, object> contextData, CancellationToken cancellationToken, bool continueOnCapturedContext) =>
        ExecuteAsync(action, new Context(contextData), cancellationToken, continueOnCapturedContext);
    ...
    /// <exception cref="InvalidOperationException">Please use asynchronous-defined policies when calling asynchronous ExecuteAsync (and similar) methods.</exception>
    [DebuggerStepThrough]
    public ValueTask<TResult> ExecuteAsync(Func<Context, CancellationToken, ValueTask<TResult>> action, Context context, CancellationToken cancellationToken, bool continueOnCapturedContext)
    {
        if (context == null)
        {
            throw new ArgumentNullException(nameof(context));
    ...
    private async ValueTask<TResult> ExecuteInternalAsync(
